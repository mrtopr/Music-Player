...
import { Play, Pause, Shuffle, ArrowLeft, Heart, MoreHorizontal, Clock, Loader2, Music, Share2 } from 'lucide-react';
        ...
        <div style={{ paddingBottom: '100px', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem', position: 'relative', zIndex: 10 }}>
                ...
                {type === 'playlist' && (
                    ...
                    }} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.5)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onMouseEnter={e => e.currentTarget.style.color = 'var(--accent-primary)'} onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.5)'} title="Share Playlist">
                        <Share2 size={24} />
                    </button>
                )}
